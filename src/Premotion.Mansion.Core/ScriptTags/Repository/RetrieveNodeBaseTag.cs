...
namespace Premotion.Mansion.Core.ScriptTags.Repository
{
	...
	/// </summary>
	public abstract class RetrieveNodeBaseTag : GetRowBaseTag
	{
		...
		/// <returns>Returns the result.</returns>
		protected abstract Node Retrieve(IMansionContext context, IPropertyBag arguments, IRepository repository);
		#endregion
	}
}