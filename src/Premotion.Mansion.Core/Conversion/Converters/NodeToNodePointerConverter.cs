...
namespace Premotion.Mansion.Core.Conversion.Converters
{
	...
	public class NodeToNodePointerConverter : ConverterBase<Node, NodePointer>
	{
		...
		protected override NodePointer DoConvert(IMansionContext context, Node source, Type sourceType)
		{
		...
		/// <returns>Returns the converted value.</returns>
		protected override NodePointer DoConvert(IMansionContext context, Node source, Type sourceType, NodePointer defaultValue)
		{
			return source.Pointer;
		}
		#endregion
