...
namespace Premotion.Mansion.Core.Conversion.Converters
{
	...
	public class NodePointerToTypeDefinitionConverter : ConverterBase<NodePointer, ITypeDefinition>
	{
		...
		protected override ITypeDefinition DoConvert(IMansionContext context, NodePointer source, Type sourceType)
		{
		...
		/// <returns>Returns the converted value.</returns>
		protected override ITypeDefinition DoConvert(IMansionContext context, NodePointer source, Type sourceType, ITypeDefinition defaultValue)
		{
			// get the type service
			var typeService = context.Nucleus.ResolveSingle<ITypeService>();
