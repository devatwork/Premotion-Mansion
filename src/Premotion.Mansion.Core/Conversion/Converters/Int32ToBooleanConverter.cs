...
namespace Premotion.Mansion.Core.Conversion.Converters
{
	...
	public class Int32ToBooleanConverter : ConverterBase<Int32, bool>
	{
		...
		protected override bool DoConvert(IMansionContext context, int source, Type sourceType)
		{
			return (source) > 0;
		}
		/// <summary>
		...
		/// <returns>Returns the converted value.</returns>
		protected override bool DoConvert(IMansionContext context, int source, Type sourceType, bool defaultValue)
		{
			return (source) > 0;
		}
		#endregion
