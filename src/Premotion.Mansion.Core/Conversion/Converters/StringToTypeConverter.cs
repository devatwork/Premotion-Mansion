...
namespace Premotion.Mansion.Core.Conversion.Converters
{
	...
	public class StringToTypeConverter : ConverterBase<string, Type>
	{
		...
		protected override Type DoConvert(IContext context, string source, Type sourceType)
		{
		...
		/// <returns>Returns the converted value.</returns>
		protected override Type DoConvert(IContext context, string source, Type sourceType, Type defaultValue)
		{
			// try to convert
			try
			{
