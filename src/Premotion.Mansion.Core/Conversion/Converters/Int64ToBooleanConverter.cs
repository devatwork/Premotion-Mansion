...
namespace Premotion.Mansion.Core.Conversion.Converters
{
	...
	public class Int64ToBooleanConverter : ConverterBase<Int64, bool>
	{
		...
		protected override bool DoConvert(IContext context, Int64 source, Type sourceType)
		{
			return (source) > 0;
		}
		/// <summary>
		...
		/// <returns>Returns the converted value.</returns>
		protected override bool DoConvert(IContext context, Int64 source, Type sourceType, bool defaultValue)
		{
			return (source) > 0;
		}
		#endregion
