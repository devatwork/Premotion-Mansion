...
namespace Premotion.Mansion.Core.Conversion.Converters
{
	...
	public class Base64ToPropertyBagConverter : ConverterBase<string, IPropertyBag>
	{
		...
		protected override IPropertyBag DoConvert(IContext context, string source, Type sourceType)
		{
			// deserialize
		...
		/// <returns>Returns the converted value.</returns>
		protected override IPropertyBag DoConvert(IContext context, string source, Type sourceType, IPropertyBag defaultValue)
		{
			try
			{
