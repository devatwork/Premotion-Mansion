...
namespace Premotion.Mansion.Core.Conversion.Converters
{
	...
	public class StringToUriConverter : ConverterBase<String, Uri>
	{
		...
		protected override Uri DoConvert(IContext context, string source, Type sourceType)
		{
		...
		/// <returns>Returns the converted value.</returns>
		protected override Uri DoConvert(IContext context, string source, Type sourceType, Uri defaultValue)
		{
			// try to convert
			try
			{
