...
namespace Premotion.Mansion.Core.Conversion.Converters
{
	...
	public class ObjectToStringConverter : ConverterBase<object, string>
	{
		...
		protected override string DoConvert(IContext context, object source, Type sourceType)
		{
		...
		/// <returns>Returns the converted value.</returns>
		protected override string DoConvert(IContext context, object source, Type sourceType, string defaultValue)
		{
			return source.ToString();
		}
		#endregion
