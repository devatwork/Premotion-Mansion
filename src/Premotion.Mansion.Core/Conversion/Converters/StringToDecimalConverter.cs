...
namespace Premotion.Mansion.Core.Conversion.Converters
{
	...
	public class StringToDecimalConverter : ConverterBase<String, decimal>
	{
		...
		protected override decimal DoConvert(IContext context, string source, Type sourceType)
		{
			source = source.Trim();
		...
		/// <returns>Returns the converted value.</returns>
		protected override decimal DoConvert(IContext context, string source, Type sourceType, decimal defaultValue)
		{
			// try to convert
			try
			{
