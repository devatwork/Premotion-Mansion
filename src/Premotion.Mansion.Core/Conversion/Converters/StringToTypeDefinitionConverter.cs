...
namespace Premotion.Mansion.Core.Conversion.Converters
{
	...
	public class StringToTypeDefinitionConverter : ConverterBase<string, ITypeDefinition>
	{
		...
		protected override ITypeDefinition DoConvert(IContext context, string source, Type sourceType)
		{
		...
		/// <returns>Returns the converted value.</returns>
		protected override ITypeDefinition DoConvert(IContext context, string source, Type sourceType, ITypeDefinition defaultValue)
		{
			try
			{
