...
namespace Premotion.Mansion.Core.Conversion.Comparers
{
	...
	public class ObjectComparer : ComparerBase<IComparable>
	{
		...
		protected override VoteResult DoVote(IMansionContext context, Type subject)
		{
		...
		protected override int Compare(IMansionContext context, IComparable left, IComparable right)
		{
