...
{
	/// <summary>
	/// Creates a <see cref="IsPropertySmallerThanOrEqualSpecification"/>.
	/// </summary>
	[ScriptFunction("IsSmallerThanOrEqualSpecification")]
	public class IsSmallerThanOrEqualSpecification : FunctionExpression
	{
		/// <summary>
		/// Creats a <see cref="IsPropertySmallerThanOrEqualSpecification"/>.
		/// </summary>
		...
		public Specification Evaluate(IMansionContext context, string propertyName, object value)
		{
			...
			return new IsPropertySmallerThanOrEqualSpecification(propertyName, value);
		}
	}
}