...
{
	/// <summary>
	/// Creates a <see cref="IsPropertyEqualSpecification"/>.
	/// </summary>
	[ScriptFunction("IsSpecification")]
	public class IsSpecification : FunctionExpression
	{
		/// <summary>
		/// Creats a <see cref="IsPropertyEqualSpecification"/>.
		/// </summary>
