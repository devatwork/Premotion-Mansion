...
{
	/// <summary>
	/// Represents a &lt;= (is less than or equal) specification on a property.
	/// </summary>
	public class IsPropertySmallerThanOrEqualSpecification : SingleValuePropertySpecification
	{
		#region Constructors
		/// <summary>
		...
		public IsPropertySmallerThanOrEqualSpecification(string propertyName, object value) : base(propertyName, value, "<=")
		{
		}
		#endregion
	}
