...
{
	/// <summary>
	/// Represents a &gt; (is greater than) specification on a property.
	/// </summary>
	public class IsPropertyGreaterThanSpecification : SingleValuePropertySpecification
	{
		#region Constructors
		/// <summary>
		...
		public IsPropertyGreaterThanSpecification(string propertyName, object value) : base(propertyName, value, ">")
		{
		}
		#endregion
	}
