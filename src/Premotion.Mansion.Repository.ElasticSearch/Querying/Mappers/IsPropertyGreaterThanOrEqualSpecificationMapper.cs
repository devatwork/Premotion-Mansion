...
{
	/// <summary>
	/// Defines the allowed roles <see cref="IsPropertyGreaterThanOrEqualSpecification"/>.
	/// </summary>
	public class IsPropertyGreaterThanOrEqualSpecificationMapper : BaseSpecificationMapper<IsPropertyGreaterThanOrEqualSpecification>
	{
		#region Overrides of BaseSpecificationMapper<IsPropertyGreaterThanOrEqualSpecification>
		/// <summary>
		...
		protected override void DoMap(IMansionContext context, Query query, IsPropertyGreaterThanOrEqualSpecification specification, SearchQuery searchQuery)
		{
			...
			// add a range filter
			searchQuery.Add(RangeFilter.GreaterThanOrEqualTo(propertyMapping.QueryField, propertyMapping.Normalize(context, specification.Value)));
		}
		#endregion
	}
}