...
{
	/// <summary>
	/// Maps <see cref="Conjunction"/>.
	/// </summary>
	public class ConjunctionMapper : BaseCompositeMapper<Conjunction>
	{
		#region Constructors
		/// <summary>
		...
		public ConjunctionMapper(INucleus nucleus) : base(nucleus)
		{
		}
		#endregion
		#region Overrides of BaseSpecificationMapper<Conjunction>
		/// <summary>
		...
		protected override void DoMap(IMansionContext context, Query query, Conjunction specification, SearchQuery searchQuery)
		{
			// create the filter
			var composite = new AndFilter();
