...
namespace Premotion.Mansion.Repository.ElasticSearch
{
	...
	public abstract class BaseReadConverter<TType> : JsonConverter
	{
		...
		public override sealed object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
		{
			...
			return DoReadJson(reader, serializer);
		}
		/// <summary>
		/// Reads the JSON representation of the object.
		/// </summary>
		...
		/// <returns>The object value.</returns>
		protected abstract object DoReadJson(JsonReader reader, JsonSerializer serializer);
		/// <summary>
		...
		{
			return typeof (TType) == objectType;
		}
		#endregion
	}
}