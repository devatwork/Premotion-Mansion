...
{
	/// <summary>
	/// Returns a comma separated list of protected words.
	/// </summary>
	[ScriptFunction("GetProtectedWordList")]
	public class GetProtectedWordList : FunctionExpression
	{
		#region Constructors
		/// <summary></summary>
		/// <param name="resourceService"></param>
		/// <exception cref="ArgumentNullException"></exception>
		public GetProtectedWordList(IApplicationResourceService resourceService)
		{
			// validate arguments
		...
		public string Evaluate(IMansionContext context, string language)
		{
			...
			// create the path
			var pathString = string.Format("Assets/{0}/protwords.txt", language);
