...
{
	/// <summary>
	/// Returns a list of stemmer override rules.
	/// </summary>
	[ScriptFunction("GetStemmerOverrideRuleList")]
	public class GetStemmerOverrideRuleList : FunctionExpression
	{
		#region Constructors
		/// <summary></summary>
		/// <param name="resourceService"></param>
		/// <exception cref="ArgumentNullException"></exception>
		public GetStemmerOverrideRuleList(IApplicationResourceService resourceService)
		{
			// validate arguments
		...
		public string Evaluate(IMansionContext context, string language)
		{
			...
			// create the path
			var pathString = string.Format("Assets/{0}/stemdict.txt", language);
