...
namespace Premotion.Mansion.Web.Controls.Forms.Fields
{
	...
	public class NumberField : Field<int>
	{
		...
		public class NumberTag : FieldFactoryTag<NumberField>
		{
			...
			protected override NumberField Create(IMansionWebContext context, ControlDefinition definition)
			{
		...
		/// </summary>
		/// <param name="definition">The <see cref="ControlDefinition"/>.</param>
		public NumberField(ControlDefinition definition) : base(definition)
		{
		}
		#endregion
