...
namespace Premotion.Mansion.Web.Controls.Forms.Fields
{
	...
	/// </summary>
	public class TagTextboxField : Field<string>
	{
		...
		public class TagTextboxFactoryTag : FieldFactoryTag<TagTextboxField>
		{
			...
			protected override TagTextboxField Create(IMansionWebContext context, ControlDefinition definition)
			{
				return new TagTextboxField(definition);
			}
			#endregion
		}
		#endregion
		...
		/// </summary>
		/// <param name="definition">The <see cref="ControlDefinition"/>.</param>
		public TagTextboxField(ControlDefinition definition) : base(definition)
		{
		}
		#endregion
