...
namespace Premotion.Mansion.Web.Security
{
	...
	public class RepositoryAuthenticationProvider : AuthenticationProvider
	{
		...
		public override IPropertyBag GetRevivalProperties(MansionContext context, UserState userState, IPropertyBag parameters)
		{
			// validate arguments
			if (context == null)
		...
		public override UserState ReviveUser(MansionContext context, IPropertyBag revivalProperties)
		{
			// validate arguments
			if (context == null)
				throw new ArgumentNullException("context");
		...
		private UserState CreateUserState(MansionContext context, Node userNode)
		{
