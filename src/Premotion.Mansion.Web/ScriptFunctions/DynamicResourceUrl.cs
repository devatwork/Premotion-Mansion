...
namespace Premotion.Mansion.Web.ScriptFunctions
{
	...
	public class DynamicResourceUrl : FunctionExpression
	{
		...
		public Uri Evaluate(MansionContext context, string relativePath)
		{
			...
			var prefixedRelativePath = HttpUtilities.CombineIntoRelativeUrl(webContext.HttpContext.Request.ApplicationPath, PathRewriterModule.DynamicResourcesPrefix, relativePath);
