...
namespace Premotion.Mansion.Web.ScriptFunctions
{
	...
	public class StreamingStaticContentUrl : FunctionExpression
	{
		...
		public Uri Evaluate(MansionContext context, string relativePath)
		{
			...
			var prefixedRelativePath = HttpUtilities.CombineIntoRelativeUrl(webContext.HttpContext.Request.ApplicationPath, PathRewriterModule.StreamingStaticContentPrefix, relativePath);
