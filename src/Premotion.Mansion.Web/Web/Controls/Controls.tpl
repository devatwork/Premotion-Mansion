...
<tpl:section name="TimeFieldControl" field="Field">
	<input type="text" id="{@ControlId}" name="{@FieldName}" class="field input-xlarge time {ControlProperties.cssClass}" value="{ControlProperties.Value}" {@FieldReadonlyAttribute}>
</tpl:section>
