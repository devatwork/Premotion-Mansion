...
namespace Premotion.Mansion.Web.Dispatcher.ScriptFunctions
{
	...
	public class RouteUrlWithArea : FunctionExpression
	{
		...
		public Uri Evaluate(IMansionContext context, string area, string controller, string action)
		{
			// validate arguments
			if (context == null)
		...
		/// <returns>Return the relative URL.</returns>
		public Uri Evaluate(IMansionContext context, string area, string controller, string action, int nodeId)
		{
			// validate arguments
			if (context == null)
				throw new ArgumentNullException("context");
