...
namespace Premotion.Mansion.Repository.SqlServer.Schemas.Descriptors
{
	...
	/// Describes a column.
	/// </summary>
	[Named(Constants.DescriptorNamespaceUri, "dateTimeColumn")]
	public class DateTimeColumnDescriptor : ColumnDescriptor
	{
		...
		public DateTimeColumnDescriptor(string namespaceUri, string name, IPropertyBag properties, ITypeDefinition typeDefinition) : base(namespaceUri, name, properties, typeDefinition)
		{
		}
		#endregion
