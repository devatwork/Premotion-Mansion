...
namespace Premotion.Mansion.Repository.SqlServer.Queries.Converters
{
	...
	/// </summary>
	public class IsPropertySmallerThanSpecificationConverter : SpecificationConverter<IsPropertySmallerThanSpecification>
	{
		#region Overrides of SpecificationConverter<IsPropertySmallerThanSpecification>
		/// <summary>
		...
		protected override void DoConvert(IMansionContext context, IsPropertySmallerThanSpecification specification, QueryCommandContext commandContext)
		{
