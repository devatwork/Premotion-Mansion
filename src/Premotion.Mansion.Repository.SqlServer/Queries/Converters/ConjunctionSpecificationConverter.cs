...
{
    /// <summary>
    /// Converts <see cref="Conjunction"/> to a statement.
    /// </summary>
    public class ConjunctionSpecificationConverter : SpecificationConverter<Conjunction>
    {
        #region Constructors
        /// <summary>
        /// </summary>
        ...
        public ConjunctionSpecificationConverter(INucleus nucleus)
        {
            // validate arguments
            if (nucleus == null)
        ...
        #endregion
        #region Overrides of SpecificationConverter<Conjunction>
        /// <summary>
        ...
        protected override void DoConvert(IMansionContext context, Conjunction specification, QueryCommandContext commandContext)
        {
