...
namespace Premotion.Mansion.Repository.SqlServer.Queries.Converters
{
	...
	/// </summary>
	public class IsPropertyGreaterThanSpecificationConverter : SpecificationConverter<IsPropertyGreaterThanSpecification>
	{
		#region Overrides of SpecificationConverter<IsPropertyGreaterThanSpecification>
		/// <summary>
		...
		protected override void DoConvert(IMansionContext context, IsPropertyGreaterThanSpecification specification, QueryCommandContext commandContext)
		{
